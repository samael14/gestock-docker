...
Le script vérifie Docker, propose le tag applicatif validé `99b86b5`, génère les secrets automatiquement, configure le `.env` de manière interactive et démarre tous les conteneurs.
...
|---|---|
| `GESTOCK_IMAGE_TAG` | Tag d'image GHCR à déployer (image validée : `99b86b5`) |
