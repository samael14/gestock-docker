...
Le script vérifie Docker, propose le tag applicatif validé `343afb2`, génère les secrets automatiquement, configure le `.env` de manière interactive et démarre tous les conteneurs.
...
|---|---|
| `GESTOCK_IMAGE_TAG` | Tag d'image GHCR à déployer (image validée : `343afb2`) |
