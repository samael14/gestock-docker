...
Le script vérifie Docker, propose le tag applicatif validé `276d9fe`, génère les secrets automatiquement, configure le `.env` de manière interactive et démarre tous les conteneurs.
...
|---|---|
| `GESTOCK_IMAGE_TAG` | Tag d'image GHCR à déployer (image validée : `276d9fe`) |
